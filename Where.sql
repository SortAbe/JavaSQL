...
SELECT lastName, gender FROM student WHERE credits = 3 AND firstName = '##';
SELECT firstName, gender FROM student WHERE credits = 3 AND firstName = '##';
SELECT * FROM student WHERE credits = 3 AND firstName = '##';
SELECT ID FROM student WHERE credits = 3 AND firstName = '##';
SELECT firstName, dept_name FROM student WHERE credits = 3 AND lastName = '##';
...
SELECT firstName, dept_name FROM instructor WHERE dept_name = '##';
SELECT firstName, gender FROM instructor WHERE ID < 10;
SELECT * FROM instructor WHERE salary = 100000 AND firstName = '##';
SELECT ID FROM instructor WHERE salary = 70000 AND firstName = '##';
SELECT ID, firstName FROM instructor WHERE salary = 90000 AND lastName = '##';
SELECT lastName, salary FROM instructor WHERE firstName LIKE '' AND lastName LIKE '';
...
SELECT city, state FROM sAddress WHERE city = '##';
SELECT zip, addr2 FROM sAddress WHERE zip = 3000;
SELECT * FROM sAddress WHERE city = '##' AND state = '##';
SELECT ID FROM sAddress WHERE zip = 4000 AND state = '##';
SELECT addr1, addr2 FROM sAddress WHERE state = '##' AND city = '##';
SELECT addr1, city FROM sAddress WHERE city LIKE 'eta' AND state LIKE 'Fl';
